...
def add_data
    first_user = User.create(Name: 'Tom', Photo: 'https://unsplash.com/photos/F_-0BxGuVvo', Bio: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae possimus sint facere 
