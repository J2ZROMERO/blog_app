...
class CreatePostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create create_post' do
    assert_difference('CreatePost.count') do
      post create_posts_url,
           params: { create_post: { AuthorId: @create_post.AuthorId, CommentsCounter: @create_post.CommentsCounter, LikesCounter: @create_post.LikesCounter, Text: @create_post.Text,
  ...
  test 'should update create_post' do
    patch create_post_url(@create_post),
          params: { create_post: { AuthorId: @create_post.AuthorId, CommentsCounter: @create_post.CommentsCounter, LikesCounter: @create_post.LikesCounter, Text: @create_post.Text,
                                   Title: @create_post.Title } }
