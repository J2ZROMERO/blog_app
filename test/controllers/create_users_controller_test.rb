...
class CreateUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create create_user" do
    assert_difference("CreateUser.count") do
      post create_users_url, params: { create_user: { .: @create_user.., Bio: @create_user.Bio, Name: @create_user.Name, Photo: @create_user.Photo, PostsCounter: @create_user.PostsCounter, add: @create_user.add, git: @create_user.git } }
    end
  ...
  test "should update create_user" do
    patch create_user_url(@create_user), params: { create_user: { .: @create_user.., Bio: @create_user.Bio, Name: @create_user.Name, Photo: @create_user.Photo, PostsCounter: @create_user.PostsCounter, add: @create_user.add, git: @create_user.git } }
